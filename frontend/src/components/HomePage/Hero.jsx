...
import FeatureCards from "./HomeComps/FeatureCards";
import LanguageSwitcher from "./HomeComps/LanguageSwitcher";
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <nav className="flex justify-between items-center px-8 py-4 mb-15">
        <div className="text-xl font-medium text-gray-900">College GPT :)</div>
        <div className="flex items-center space-x-4">
          <button
            onClick={() => setIsSignupOpen(true)}
            className="px-4 py-1 text-gray-700 hover:text-gray-900 transition-colors border border-gray-300 rounded-full shadow-sm hover:shadow-md cursor-pointer"
          >
            Login/Sign Up
          </button>
      ...
      {/* Main Content */}
      <div className="flex-1 flex items-center justify-center px-8 mt-14">
        <div className="max-w-4xl mx-auto text-center relative">
          {/* Decorative Labels */}
          <div className="absolute -top-16 -left-10 text-gray-400 text-lg font-light italic transform -rotate-12">
            Smart
          </div>
          ...
          <div className="mt-12">
            <div className="relative max-w-md mx-auto">
              <input
                ...
                className="w-full px-6 py-4 text-gray-300 bg-black rounded-full border-none outline-none text-lg placeholder-zinc-300"
              />
      ...
      {/* Bottom Arrow */}
      <div className="text-center pb-8 mt-29">
      ...
      <div className="flex justify-center items-center space-x-6 py-16 bg-gray-50 mb-[100px]">
        ...
        <button className="bg-black text-white px-6 py-3 rounded-full text-sm font-medium hover:bg-white hover:text-black hover:border hover:border-black transition-colors cursor-pointer">
          Start chatting now →
        </button>
      </div>
